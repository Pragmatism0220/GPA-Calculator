...
exit
:CreateShortcut
mshta VBScript:Execute("Set a=CreateObject(""WScript.Shell""):Set b=a.CreateShortcut(a.SpecialFolders(""Desktop"") & ""\GPA计算器.lnk""):b.TargetPath=""%~dp0\GPA计算器.exe"":b.WorkingDirectory=""%~dp0"":b.IconLocation=""%~dp0\calculator.ico,0"":b.Save:close")
echo exe桌面快捷方式创建成功！
echo(
pause